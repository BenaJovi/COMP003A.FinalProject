    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (FirstName != lastName)
            {
                ...
                string[] QuestArray = new string[] { Wheight, Wweight, PhysicallyActive, DailyWalk, Wmiles, Wfastfood, Wcalorieintake, LoseWeight, Wdays }; // TODO: name this variable more appropriately (e.g., responses)
